...
from jarvis.capabilities.tools.player import PlayerTool
...
def build(
    ...
    # ShowViewTool/PlayerTool dépendent de proactive_queue, donc enregistrés après.
    tool_registry.register(ShowViewTool(broadcast_event=proactive_queue.broadcast_event))
    tool_registry.register(PlayerTool(broadcast_event=proactive_queue.broadcast_event))
