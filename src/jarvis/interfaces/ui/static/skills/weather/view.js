...
(function () {
  ...
  Jarvis.views.register(VIEW_ID, {
    ...
    show(params = {}) {
      ...
      // données réelles : par ville demandée, par coordonnées, par ville "maison"
      // (HOME_CITY, cf. Réglages > Proactivité) si rien n'est précisé, ou Paris
      // en tout dernier recours (aucune ville configurée).
      ...
      else if (window.JARVIS_HOME_CITY) geocodeAndFetch(window.JARVIS_HOME_CITY);
