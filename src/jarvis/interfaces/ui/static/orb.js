  ...
  function createOrbInternal(canvas, opts) {
    ...
    return {
      ...
      destroy() {
        ...
        ro.disconnect();
        renderer.dispose();
        // dispose() libère la mémoire GPU (textures/programmes) mais PAS le
        // contexte WebGL lui-même — sans ça, des créations/destructions
        // répétées (ex. scan facial du Mode veille, relancé à chaque essai)
        // finissent par épuiser le nombre de contextes WebGL autorisés par
        // le navigateur ("WebGL creation failed... Exhausted GL driver
        // options"), rendant Jarvis incapable d'afficher quoi que ce soit.
