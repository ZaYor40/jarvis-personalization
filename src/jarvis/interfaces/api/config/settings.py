...
async def get_settings_endpoint() -> dict:
    ...
    return {
        ...
        "llm": {
            ...
            "mistral_model": _ev("MISTRAL_MODEL", "mistral_model"),
            "openai_model": _ev("OPENAI_MODEL", "openai_model"),
        ...
        "jarvis": {
            ...
            "assistant_name": _ev("ASSISTANT_NAME", "assistant_name"),
        ...
        "music": {
            ...
            "music_library_dir": _ev("MUSIC_LIBRARY_DIR", "music_library_dir"),
        },
