...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/approvals.py`
- **Purpose:** Système d'approbation par catégorie — loader kernel.
- **Key symbols:** Classes: `ApprovalMode`, `ApprovalConfig`; Functions: `load_approval_config`, `save_approval_config`
...
- **Source of truth:** [src/jarvis/kernel/approvals.py](../../src/jarvis/kernel/approvals.py)
