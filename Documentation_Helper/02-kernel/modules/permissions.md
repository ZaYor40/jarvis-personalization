...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/permissions.py`
- **Purpose:** Module `kernel/permissions.py`.
- **Key symbols:** Classes: `PermissionStore`
...
- **Source of truth:** [src/jarvis/kernel/permissions.py](../../src/jarvis/kernel/permissions.py)
