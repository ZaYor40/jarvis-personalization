...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/backends.py`
- **Purpose:** Configuration des backends d'exécution — loader kernel.
- **Key symbols:** Classes: `BackendType`, `SSHConfig`, `BackendsConfig`; Functions: `load_backends_config`, `save_backends_config`
...
- **Source of truth:** [src/jarvis/kernel/backends.py](../../src/jarvis/kernel/backends.py)
