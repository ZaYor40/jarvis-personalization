...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/settings.py`
- **Purpose:** Module `kernel/settings.py`.
- **Key symbols:** Classes: `Settings`
...
- **Source of truth:** [src/jarvis/kernel/settings.py](../../src/jarvis/kernel/settings.py)
