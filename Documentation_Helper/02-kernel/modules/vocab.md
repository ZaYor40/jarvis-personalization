...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/vocab.py`
- **Purpose:** Vocabulaires fermés, niveaux d'accès et d'autonomie — contrat PHASE 0 (§3.1–§3.3).
- **Key symbols:** Classes: `AccessLevel`, `AutonomyLevel`
...
- **Source of truth:** [src/jarvis/kernel/vocab.py](../../src/jarvis/kernel/vocab.py)
