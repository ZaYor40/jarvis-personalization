...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/__init__.py`
- **Purpose:** kernel — L0 de l'architecture jarvis-OS.
...
- **Source of truth:** [src/jarvis/kernel/__init__.py](../../src/jarvis/kernel/__init__.py)
