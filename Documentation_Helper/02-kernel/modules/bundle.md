...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/bundle.py`
- **Purpose:** Module `kernel/bundle.py`.
- **Key symbols:** Functions: `_venv_python`, `_monorepo_python`, `_rel_project`, `_python_version`, `_detect_system_python`, `_python_runtime_info`, `inspect_bundle`, `bundle_available`, `load_manifest`, `resolve_python`, `resolve_uv`, `_platform_bin_name`
...
- **Source of truth:** [src/jarvis/kernel/bundle.py](../../src/jarvis/kernel/bundle.py)
