...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/setup_layout.py`
- **Purpose:** Module `kernel/setup_layout.py`.
- **Key symbols:** Functions: `ensure_runtime_layout`, `read_env_file`, `is_setup_complete`
...
- **Source of truth:** [src/jarvis/kernel/setup_layout.py](../../src/jarvis/kernel/setup_layout.py)
