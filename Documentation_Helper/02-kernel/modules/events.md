...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/events.py`
- **Purpose:** Bus d'événements pub/sub asyncio — CDC §A.1.3.
- **Key symbols:** Classes: `MissionCompleted`, `MemoryIngested`, `NotificationRequested`, `BudgetThresholdReached`, `EventBus`
...
- **Source of truth:** [src/jarvis/kernel/events.py](../../src/jarvis/kernel/events.py)
