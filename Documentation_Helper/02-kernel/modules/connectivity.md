...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/connectivity.py`
- **Purpose:** Module `kernel/connectivity.py`.
- **Key symbols:** Functions: `is_offline_mode`
...
- **Source of truth:** [src/jarvis/kernel/connectivity.py](../../src/jarvis/kernel/connectivity.py)
