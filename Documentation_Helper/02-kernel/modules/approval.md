...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/approval.py`
- **Purpose:** Singleton accessor pour l'ApprovalChecker — Phase F.
- **Key symbols:** Functions: `get_approval_checker`, `set_approval_checker`
...
- **Source of truth:** [src/jarvis/kernel/approval.py](../../src/jarvis/kernel/approval.py)
