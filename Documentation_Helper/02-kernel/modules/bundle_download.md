...
- **Layer:** L0
- **Path:** `src/jarvis/kernel/bundle_download.py`
- **Purpose:** Module `kernel/bundle_download.py`.
- **Key symbols:** Functions: `_zip_member_dest`, `_safe_dest`
...
- **Source of truth:** [src/jarvis/kernel/bundle_download.py](../../src/jarvis/kernel/bundle_download.py)
