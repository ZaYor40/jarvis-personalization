...
- **Layer:** L2
- **Path:** `src/jarvis/engine/background/scheduler.py`
- **Purpose:** Module `engine/background/scheduler.py`.
- **Key symbols:** Classes: `Scheduler`; Functions: `_next_datetime`, `_seconds_until`
...
- **Source of truth:** [src/jarvis/engine/background/scheduler.py](../../src/jarvis/engine/background/scheduler.py)
