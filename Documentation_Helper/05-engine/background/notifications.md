...
- **Layer:** L2
- **Path:** `src/jarvis/engine/background/notifications.py`
- **Purpose:** Module `engine/background/notifications.py`.
- **Key symbols:** Classes: `Notification`, `NotificationQueue`, `ProactiveQueue`; Functions: `set_proactive_queue`, `get_broadcast_fn`
...
- **Source of truth:** [src/jarvis/engine/background/notifications.py](../../src/jarvis/engine/background/notifications.py)
