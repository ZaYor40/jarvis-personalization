...
- **Layer:** L2
- **Path:** `src/jarvis/engine/background/worker.py`
- **Purpose:** Module `engine/background/worker.py`.
- **Key symbols:** Classes: `BackgroundTask`, `TaskRecord`, `BackgroundWorker`
...
- **Source of truth:** [src/jarvis/engine/background/worker.py](../../src/jarvis/engine/background/worker.py)
