...
- **Layer:** L2
- **Path:** `src/jarvis/engine/background/__init__.py`
- **Purpose:** Module `engine/background/__init__.py`.
...
- **Source of truth:** [src/jarvis/engine/background/__init__.py](../../src/jarvis/engine/background/__init__.py)
