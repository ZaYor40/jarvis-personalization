...
- **Layer:** L2
- **Path:** `src/jarvis/engine/background/routines.py`
- **Purpose:** background/routines.py — Moteur de routines planifiées de Jarvis.
- **Key symbols:** Classes: `TriggerType`, `ConcurrencyPolicy`, `CatchUpPolicy`, `RunStatus`, `AuditStep`, `Routine`, `RoutineRun`, `RoutineStore`; Functions: `next_cron_datetime`
...
- **Source of truth:** [src/jarvis/engine/background/routines.py](../../src/jarvis/engine/background/routines.py)
