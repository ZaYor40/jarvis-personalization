...
- **Layer:** L2
- **Path:** `src/jarvis/engine/auth.py`
- **Purpose:** Garde-fou réseau — authentification Bearer pour l'API Jarvis.
...
- **Source of truth:** [src/jarvis/engine/auth.py](../../src/jarvis/engine/auth.py)
