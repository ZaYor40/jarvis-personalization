...
- **Layer:** L2
- **Path:** `src/jarvis/engine/approval_checker.py`
- **Purpose:** Vérifie si une action nécessite une approbation avant d'être exécutée.
- **Key symbols:** Classes: `ApprovalChecker`
...
- **Source of truth:** [src/jarvis/engine/approval_checker.py](../../src/jarvis/engine/approval_checker.py)
