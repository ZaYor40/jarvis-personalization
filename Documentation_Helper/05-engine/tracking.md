...
- **Layer:** L2
- **Path:** `src/jarvis/engine/tracking.py`
- **Purpose:** Module `engine/tracking.py`.
- **Key symbols:** Classes: `UsageTracker`
...
- **Source of truth:** [src/jarvis/engine/tracking.py](../../src/jarvis/engine/tracking.py)
