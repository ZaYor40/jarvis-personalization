...
- **Layer:** L2
- **Path:** `src/jarvis/engine/agent.py`
- **Purpose:** Module `engine/agent.py`.
- **Key symbols:** Classes: `Agent`; Functions: `_clip_tool_result`
...
- **Source of truth:** [src/jarvis/engine/agent.py](../../src/jarvis/engine/agent.py)
