...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/ssh.py`
- **Purpose:** SSHBackend — exécution sur hôte distant via SSH avec ControlMaster.
- **Key symbols:** Classes: `SSHBackend`
...
- **Source of truth:** [src/jarvis/engine/mission/backends/ssh.py](../../src/jarvis/engine/mission/backends/ssh.py)
