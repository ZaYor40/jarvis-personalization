...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/docker_executor.py`
- **Purpose:** DockerExecutor — exécution isolée dans un container Docker jetable.
- **Key symbols:** Classes: `DockerExecutor`
...
- **Source of truth:** [src/jarvis/engine/mission/docker_executor.py](../../src/jarvis/engine/mission/docker_executor.py)
