...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/local.py`
- **Purpose:** LocalBackend — exécution directe sur l'hôte dans le workspace (opt-in explicite).
- **Key symbols:** Classes: `LocalBackend`
...
- **Source of truth:** [src/jarvis/engine/mission/backends/local.py](../../src/jarvis/engine/mission/backends/local.py)
