...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/capability_engine.py`
- **Purpose:** Capability Engine (CDC §8) — détection de gap + délégation au SkillLab.
- **Key symbols:** Classes: `ResolutionKind`, `CapabilityGapResolution`, `WhitelistDomain`, `Whitelist`, `CapabilityEngine`; Functions: `_tokenize`, `_jaccard`, `_looks_dangerous`
...
- **Source of truth:** [src/jarvis/engine/mission/capability_engine.py](../../src/jarvis/engine/mission/capability_engine.py)
