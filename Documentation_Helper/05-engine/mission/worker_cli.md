...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/worker_cli.py`
- **Purpose:** CLI sandboxé pour le WorkerAgent — whitelist stricte + exécution dans le workspace.
- **Key symbols:** Classes: `WorkerCLITool`
...
- **Source of truth:** [src/jarvis/engine/mission/worker_cli.py](../../src/jarvis/engine/mission/worker_cli.py)
