...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/project_manager.py`
- **Purpose:** ProjectManager — analyse une mission et la décompose en étapes exécutables.
- **Key symbols:** Classes: `ProjectManager`
...
- **Source of truth:** [src/jarvis/engine/mission/project_manager.py](../../src/jarvis/engine/mission/project_manager.py)
