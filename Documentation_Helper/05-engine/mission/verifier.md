...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/verifier.py`
- **Purpose:** Self-verification en 3 couches (CDC §4.3).
- **Key symbols:** Classes: `VerificationResult`, `Verifier`
...
- **Source of truth:** [src/jarvis/engine/mission/verifier.py](../../src/jarvis/engine/mission/verifier.py)
