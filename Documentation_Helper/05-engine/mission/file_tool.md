...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/file_tool.py`
- **Purpose:** Outil fichiers sandboxé — toutes les opérations confinées au workspace du projet.
- **Key symbols:** Classes: `SandboxedFileTool`
...
- **Source of truth:** [src/jarvis/engine/mission/file_tool.py](../../src/jarvis/engine/mission/file_tool.py)
