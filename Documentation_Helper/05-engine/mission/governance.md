...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/governance.py`
- **Purpose:** Gate composite à 3 axes (CDC §9, option α PHASE 1).
- **Key symbols:** Classes: `GateDecision`, `GateContext`, `Governance`
...
- **Source of truth:** [src/jarvis/engine/mission/governance.py](../../src/jarvis/engine/mission/governance.py)
