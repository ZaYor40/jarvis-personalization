...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/schemas.py`
- **Purpose:** Ré-export de kernel.schemas (section Agent) — CDC §A.1.3.
...
- **Source of truth:** [src/jarvis/engine/mission/schemas.py](../../src/jarvis/engine/mission/schemas.py)
