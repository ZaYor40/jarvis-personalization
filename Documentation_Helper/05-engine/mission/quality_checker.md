...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/quality_checker.py`
- **Purpose:** QualityChecker — vérifications automatiques de qualité post-étape et fin de projet.
- **Key symbols:** Classes: `QualityChecker`
...
- **Source of truth:** [src/jarvis/engine/mission/quality_checker.py](../../src/jarvis/engine/mission/quality_checker.py)
