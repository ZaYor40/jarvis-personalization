...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/rpc.py`
- **Purpose:** Pattern script-via-RPC : un pipeline multi-étapes = un seul tour LLM.
- **Key symbols:** Classes: `ScriptRPCRunner`; Functions: `_build_stub`
...
- **Source of truth:** [src/jarvis/engine/mission/backends/rpc.py](../../src/jarvis/engine/mission/backends/rpc.py)
