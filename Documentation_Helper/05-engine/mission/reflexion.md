...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/reflexion.py`
- **Purpose:** Réflexion post-mission (CDC §5).
- **Key symbols:** Classes: `MissionLesson`, `Reflexion`; Functions: `_parse_lesson_json`
...
- **Source of truth:** [src/jarvis/engine/mission/reflexion.py](../../src/jarvis/engine/mission/reflexion.py)
