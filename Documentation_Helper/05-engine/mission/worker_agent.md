...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/worker_agent.py`
- **Purpose:** WorkerAgent — exécute les étapes d'un projet avec un vrai tool_loop Anthropic.
- **Key symbols:** Classes: `_BudgetExceeded`, `WorkerAgent`
...
- **Source of truth:** [src/jarvis/engine/mission/worker_agent.py](../../src/jarvis/engine/mission/worker_agent.py)
