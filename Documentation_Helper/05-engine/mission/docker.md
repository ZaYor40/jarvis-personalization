...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/docker.py`
- **Purpose:** DockerBackend — délègue l'exécution au DockerExecutor déjà démarré.
- **Key symbols:** Classes: `DockerBackend`
...
- **Source of truth:** [src/jarvis/engine/mission/backends/docker.py](../../src/jarvis/engine/mission/backends/docker.py)
