...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/__init__.py`
- **Purpose:** Package backends — abstraction d'exécution multi-environnement pour Jarvis.
- **Key symbols:** See source file.
...
- **Source of truth:** [src/jarvis/engine/mission/backends/__init__.py](../../src/jarvis/engine/mission/backends/__init__.py)
