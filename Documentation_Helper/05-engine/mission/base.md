...
- **Layer:** L2
- **Path:** `src/jarvis/engine/mission/backends/base.py`
- **Purpose:** ABC ExecutionBackend — contrat partagé par tous les backends d'exécution.
- **Key symbols:** Classes: `BackendResult`, `ExecutionBackend`
...
- **Source of truth:** [src/jarvis/engine/mission/backends/base.py](../../src/jarvis/engine/mission/backends/base.py)
