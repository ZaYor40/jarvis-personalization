...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/weather.py`
- **Purpose:** Module `engine/proactive/collectors/weather.py`.
- **Key symbols:** Classes: `WeatherCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/weather.py](../../src/jarvis/engine/proactive/collectors/weather.py)
