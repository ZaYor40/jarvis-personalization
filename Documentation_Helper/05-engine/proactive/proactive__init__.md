...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/__init__.py`
- **Purpose:** Module `engine/proactive/__init__.py`.
...
- **Source of truth:** [src/jarvis/engine/proactive/__init__.py](../../src/jarvis/engine/proactive/__init__.py)
