...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/context_builder.py`
- **Purpose:** ContextBuilder — fusionne toutes les sources en un état du monde cohérent.
- **Key symbols:** Classes: `WorldState`, `ContextBuilder`
...
- **Source of truth:** [src/jarvis/engine/proactive/context_builder.py](../../src/jarvis/engine/proactive/context_builder.py)
