...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/voice_agent.py`
- **Purpose:** Module `engine/proactive/voice_agent.py`.
...
- **Source of truth:** [src/jarvis/engine/proactive/voice_agent.py](../../src/jarvis/engine/proactive/voice_agent.py)
