...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/base.py`
- **Purpose:** Module `engine/proactive/collectors/base.py`.
- **Key symbols:** Classes: `CollectorBase`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/base.py](../../src/jarvis/engine/proactive/collectors/base.py)
