...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/email.py`
- **Purpose:** EmailCollector — récupère les emails non lus avec le corps complet du thread.
- **Key symbols:** Classes: `EmailCollector`; Functions: `_extract_text_body`, `_load_gmail_creds`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/email.py](../../src/jarvis/engine/proactive/collectors/email.py)
