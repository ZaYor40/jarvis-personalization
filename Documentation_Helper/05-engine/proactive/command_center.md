...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/command_center.py`
- **Purpose:** Command Center (CDC §10.2) — vue unifiée des workstreams en cours.
- **Key symbols:** Classes: `InitiativeSummary`, `MissionSummary`, `BudgetSummary`, `SkillSummary`, `CommandCenterSnapshot`, `CommandCenter`
...
- **Source of truth:** [src/jarvis/engine/proactive/command_center.py](../../src/jarvis/engine/proactive/command_center.py)
