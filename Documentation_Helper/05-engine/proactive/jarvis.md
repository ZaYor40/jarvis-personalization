...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/jarvis.py`
- **Purpose:** JarvisCollector — collecte l'état interne de Jarvis.
- **Key symbols:** Classes: `JarvisCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/jarvis.py](../../src/jarvis/engine/proactive/collectors/jarvis.py)
