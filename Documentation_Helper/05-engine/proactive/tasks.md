...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/tasks.py`
- **Purpose:** TaskCollector — récupère les tâches Notion non cochées.
- **Key symbols:** Classes: `TaskCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/tasks.py](../../src/jarvis/engine/proactive/collectors/tasks.py)
