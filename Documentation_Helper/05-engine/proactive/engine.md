...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/engine.py`
- **Purpose:** ProactiveEngine — orchestrateur principal.
- **Key symbols:** Classes: `ProactiveAuditEvent`, `ProactiveEngine`; Functions: `_extract_sources`
...
- **Source of truth:** [src/jarvis/engine/proactive/engine.py](../../src/jarvis/engine/proactive/engine.py)
