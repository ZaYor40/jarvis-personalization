...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/home_assistant.py`
- **Purpose:** Module `engine/proactive/collectors/home_assistant.py`.
- **Key symbols:** Classes: `HomeAssistantCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/home_assistant.py](../../src/jarvis/engine/proactive/collectors/home_assistant.py)
