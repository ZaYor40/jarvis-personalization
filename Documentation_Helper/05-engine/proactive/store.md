...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/store.py`
- **Purpose:** InitiativeStore — persistance des initiatives sur le disque.
- **Key symbols:** Classes: `InitiativeStore`; Functions: `_title_key`, `_jaccard`, `_shares_keyword`, `_similar`, `_dedup_initiatives`
...
- **Source of truth:** [src/jarvis/engine/proactive/store.py](../../src/jarvis/engine/proactive/store.py)
