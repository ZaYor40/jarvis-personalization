...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/__init__.py`
- **Purpose:** Module `engine/proactive/collectors/__init__.py`.
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/__init__.py](../../src/jarvis/engine/proactive/collectors/__init__.py)
