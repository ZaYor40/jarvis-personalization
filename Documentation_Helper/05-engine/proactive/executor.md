...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/executor.py`
- **Purpose:** InitiativeExecutor — exécution pilotée des initiatives avec garde-fous.
- **Key symbols:** Classes: `_Orchestrator`, `_ApprovalChecker`, `_BudgetGuard`, `InitiativeExecutor`
...
- **Source of truth:** [src/jarvis/engine/proactive/executor.py](../../src/jarvis/engine/proactive/executor.py)
