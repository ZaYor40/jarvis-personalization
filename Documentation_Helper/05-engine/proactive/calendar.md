...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/calendar.py`
- **Purpose:** CalendarCollector — récupère les événements des prochaines 48h.
- **Key symbols:** Classes: `CalendarCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/calendar.py](../../src/jarvis/engine/proactive/collectors/calendar.py)
