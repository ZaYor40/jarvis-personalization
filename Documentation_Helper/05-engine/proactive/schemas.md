...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/schemas.py`
- **Purpose:** Ré-export de kernel.schemas (section Proactive) — CDC §A.1.3.
...
- **Source of truth:** [src/jarvis/engine/proactive/schemas.py](../../src/jarvis/engine/proactive/schemas.py)
