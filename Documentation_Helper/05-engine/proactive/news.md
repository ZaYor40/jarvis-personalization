...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/collectors/news.py`
- **Purpose:** NewsCollector — agrège les actualités pertinentes via RSS.
- **Key symbols:** Classes: `NewsCollector`
...
- **Source of truth:** [src/jarvis/engine/proactive/collectors/news.py](../../src/jarvis/engine/proactive/collectors/news.py)
