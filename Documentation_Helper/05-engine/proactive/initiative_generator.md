# initiative_generator.py

- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/initiative_generator.py`
- **Purpose:** InitiativeGenerator — analyse l'état du monde et génère des initiatives.
- **Key symbols:** Classes: `InitiativeGenerator`; Functions: `_title_key`, `_word_overlap`, `_dedup_similar`, `_is_valid_json`, `_salvage_json`, `_apply_caps`, `_initiative_system`, `_draft_system`, `_rectify_system`
...
- **Source of truth:** [src/jarvis/engine/proactive/initiative_generator.py](../../src/jarvis/engine/proactive/initiative_generator.py)
