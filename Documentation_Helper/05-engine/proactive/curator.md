...
- **Layer:** L2
- **Path:** `src/jarvis/engine/proactive/curator.py`
- **Purpose:** Curator nocturne (CDC §10.3) — rapport + patches PROPOSÉS, jamais appliqués MVP.
- **Key symbols:** Classes: `PatchKind`, `CuratorPatch`, `CuratorReport`, `Curator`; Functions: `is_protected_path`, `_report_to_dict`, `_report_from_dict`, `_render_markdown`
...
- **Source of truth:** [src/jarvis/engine/proactive/curator.py](../../src/jarvis/engine/proactive/curator.py)
