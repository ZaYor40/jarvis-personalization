...
- **Layer:** L2
- **Path:** `src/jarvis/engine/gateway.py`
- **Purpose:** Module `engine/gateway.py`.
- **Key symbols:** Classes: `Gateway`; Functions: `_fallback`
...
- **Source of truth:** [src/jarvis/engine/gateway.py](../../src/jarvis/engine/gateway.py)
