...
- **Layer:** L2
- **Path:** `src/jarvis/engine/llm_errors.py`
- **Purpose:** Module `engine/llm_errors.py`.
- **Key symbols:** Functions: `llm_config_error`, `friendly_llm_error`
...
- **Source of truth:** [src/jarvis/engine/llm_errors.py](../../src/jarvis/engine/llm_errors.py)
