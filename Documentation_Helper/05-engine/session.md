...
- **Layer:** L2
- **Path:** `src/jarvis/engine/session.py`
- **Purpose:** Module `engine/session.py`.
- **Key symbols:** Classes: `SessionManager`
...
- **Source of truth:** [src/jarvis/engine/session.py](../../src/jarvis/engine/session.py)
