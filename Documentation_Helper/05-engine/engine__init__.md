...
- **Layer:** L2
- **Path:** `src/jarvis/engine/__init__.py`
- **Purpose:** L2 — Engine : orchestration métier (RÈGLE 3 — n'importe que kernel).
...
- **Source of truth:** [src/jarvis/engine/__init__.py](../../src/jarvis/engine/__init__.py)
