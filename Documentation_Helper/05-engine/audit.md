...
- **Layer:** L2
- **Path:** `src/jarvis/engine/audit.py`
- **Purpose:** Log d'audit immuable des décisions du gate composite (§9).
- **Key symbols:** Classes: `AuditEntry`, `AuditLog`
...
- **Source of truth:** [src/jarvis/engine/audit.py](../../src/jarvis/engine/audit.py)
