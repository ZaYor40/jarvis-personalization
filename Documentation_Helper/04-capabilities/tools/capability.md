...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/capability.py`
- **Purpose:** Tool LLM pour signaler un manque de capacité (PHASE 5 §8).
- **Key symbols:** Classes: `ReportMissingCapabilityTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/capability.py](../../src/jarvis/capabilities/tools/capability.py)
