...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/filesystem.py`
- **Purpose:** Module `capabilities/tools/filesystem.py`.
- **Key symbols:** Classes: `ReadFileTool`, `FindFilesTool`; Functions: `_walk_filtered`
...
- **Source of truth:** [src/jarvis/capabilities/tools/filesystem.py](../../src/jarvis/capabilities/tools/filesystem.py)
