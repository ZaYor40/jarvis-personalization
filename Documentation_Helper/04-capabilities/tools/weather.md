...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/weather.py`
- **Purpose:** Module `capabilities/tools/weather.py`.
- **Key symbols:** Classes: `WeatherTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/weather.py](../../src/jarvis/capabilities/tools/weather.py)
