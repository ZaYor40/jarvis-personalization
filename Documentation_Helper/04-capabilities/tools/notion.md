...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/notion.py`
- **Purpose:** Module `capabilities/tools/notion.py`.
- **Key symbols:** Classes: `NotionTasksTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/notion.py](../../src/jarvis/capabilities/tools/notion.py)
