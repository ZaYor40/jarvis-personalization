...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/skills.py`
- **Purpose:** Outils LLM pour la gestion des skills Jarvis (création, amélioration, liste).
- **Key symbols:** Classes: `SkillCreateTool`, `SkillImproveTool`, `SkillListTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/skills.py](../../src/jarvis/capabilities/tools/skills.py)
