...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/browser.py`
- **Purpose:** Module `capabilities/tools/browser.py`.
- **Key symbols:** Classes: `BrowserTool`; Functions: `_validate_url`
...
- **Source of truth:** [src/jarvis/capabilities/tools/browser.py](../../src/jarvis/capabilities/tools/browser.py)
