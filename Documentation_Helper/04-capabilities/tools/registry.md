...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/registry.py`
- **Purpose:** Module `capabilities/tools/registry.py`.
- **Key symbols:** Classes: `ToolRegistry`
...
- **Source of truth:** [src/jarvis/capabilities/tools/registry.py](../../src/jarvis/capabilities/tools/registry.py)
