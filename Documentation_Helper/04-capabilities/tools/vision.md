...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/vision.py`
- **Purpose:** Module `capabilities/tools/vision.py`.
- **Key symbols:** Classes: `VisionTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/vision.py](../../src/jarvis/capabilities/tools/vision.py)
