...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/printer.py`
- **Purpose:** Outil imprimante 3D pour Jarvis — BambuLab.
- **Key symbols:** Classes: `Printer3DTool`; Functions: `_require_bambu`, `_make_printer`, `_wait_ready`
...
- **Source of truth:** [src/jarvis/capabilities/tools/printer.py](../../src/jarvis/capabilities/tools/printer.py)
