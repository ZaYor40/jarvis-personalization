...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/calendar.py`
- **Purpose:** Module `capabilities/tools/calendar.py`.
- **Key symbols:** Classes: `CalendarListTool`, `CalendarCreateTool`; Functions: `_load_creds`
...
- **Source of truth:** [src/jarvis/capabilities/tools/calendar.py](../../src/jarvis/capabilities/tools/calendar.py)
