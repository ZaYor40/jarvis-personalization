...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/cli.py`
- **Purpose:** Module `capabilities/tools/cli.py`.
- **Key symbols:** Classes: `_PendingApproval`, `CLIRunnerTool`, `ExecuteCLITool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/cli.py](../../src/jarvis/capabilities/tools/cli.py)
