...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/map_control.py`
- **Purpose:** Module `capabilities/tools/map_control.py`.
- **Key symbols:** Classes: `MapControlTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/map_control.py](../../src/jarvis/capabilities/tools/map_control.py)
