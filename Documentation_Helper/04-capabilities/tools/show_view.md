...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/show_view.py`
- **Purpose:** Module `capabilities/tools/show_view.py`.
- **Key symbols:** Classes: `ShowViewTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/show_view.py](../../src/jarvis/capabilities/tools/show_view.py)
