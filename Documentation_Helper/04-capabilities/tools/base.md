...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/base.py`
- **Purpose:** Module `capabilities/tools/base.py`.
- **Key symbols:** Classes: `ToolResult`, `Tool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/base.py](../../src/jarvis/capabilities/tools/base.py)
