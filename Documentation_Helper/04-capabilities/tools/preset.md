...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/preset.py`
- **Purpose:** Outil execute_preset — permet à Jarvis de lancer un preset.
- **Key symbols:** Classes: `ExecutePresetTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/preset.py](../../src/jarvis/capabilities/tools/preset.py)
