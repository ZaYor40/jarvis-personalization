...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/memory.py`
- **Purpose:** Module `capabilities/tools/memory.py`.
- **Key symbols:** Classes: `MemoryTopicWriteTool`, `MemoryLoadTopicTool`, `MemorySearchTool`, `CrossSessionRecallTool`; Functions: `_is_invalid_filename`
...
- **Source of truth:** [src/jarvis/capabilities/tools/memory.py](../../src/jarvis/capabilities/tools/memory.py)
