...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/spotify.py`
- **Purpose:** Module `capabilities/tools/spotify.py`.
- **Key symbols:** Classes: `SpotifyTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/spotify.py](../../src/jarvis/capabilities/tools/spotify.py)
