...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/gmail.py`
- **Purpose:** Module `capabilities/tools/gmail.py`.
- **Key symbols:** Classes: `GmailListTool`; Functions: `_load_gmail_creds`, `_load_gmail_send_creds`, `_parse_draft`
...
- **Source of truth:** [src/jarvis/capabilities/tools/gmail.py](../../src/jarvis/capabilities/tools/gmail.py)
