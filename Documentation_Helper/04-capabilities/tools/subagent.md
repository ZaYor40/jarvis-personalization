...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/subagent.py`
- **Purpose:** Outils de délégation — sous-agent isolé et exécution de script via RPC.
- **Key symbols:** Classes: `SpawnSubagentTool`, `ScriptRPCTool`
...
- **Source of truth:** [src/jarvis/capabilities/tools/subagent.py](../../src/jarvis/capabilities/tools/subagent.py)
