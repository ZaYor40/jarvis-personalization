...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/spotify_auth.py`
- **Purpose:** Spotify OAuth token management — Phase E §E.1.1.
- **Key symbols:** Functions: `_token_path`, `_load_token`, `_save_token`, `_basic_auth`
...
- **Source of truth:** [src/jarvis/capabilities/tools/spotify_auth.py](../../src/jarvis/capabilities/tools/spotify_auth.py)
