...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/fusion.py`
- **Purpose:** Outil Fusion 360 pour Jarvis — Autodesk MCP HTTP (port 27182).
- **Key symbols:** Classes: `_FusionClient`, `FusionTool`; Functions: `_parse_sse`, `_wrap_script`
...
- **Source of truth:** [src/jarvis/capabilities/tools/fusion.py](../../src/jarvis/capabilities/tools/fusion.py)
