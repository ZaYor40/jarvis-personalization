...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/tools/__init__.py`
- **Purpose:** Module `capabilities/tools/__init__.py`.
...
- **Source of truth:** [src/jarvis/capabilities/tools/__init__.py](../../src/jarvis/capabilities/tools/__init__.py)
