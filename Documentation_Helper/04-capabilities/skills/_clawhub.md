...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/_clawhub.py`
- **Purpose:** Module `capabilities/skills/_clawhub.py`.
...
- **Source of truth:** [src/jarvis/capabilities/skills/_clawhub.py](../../src/jarvis/capabilities/skills/_clawhub.py)
