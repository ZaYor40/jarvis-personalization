...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/app_checker.py`
- **Purpose:** Vérifie si les applications requises par un skill sont installées.
- **Key symbols:** Functions: `check_app_installed`, `check_all_apps`
...
- **Source of truth:** [src/jarvis/capabilities/skills/app_checker.py](../../src/jarvis/capabilities/skills/app_checker.py)
