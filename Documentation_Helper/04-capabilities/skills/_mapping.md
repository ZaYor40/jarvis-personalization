...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/_mapping.py`
- **Purpose:** Module `capabilities/skills/_mapping.py`.
- **Key symbols:** Functions: `resolve_tool`
...
- **Source of truth:** [src/jarvis/capabilities/skills/_mapping.py](../../src/jarvis/capabilities/skills/_mapping.py)
