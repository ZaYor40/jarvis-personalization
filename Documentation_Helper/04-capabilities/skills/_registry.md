...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/_registry.py`
- **Purpose:** Module `capabilities/skills/_registry.py`.
...
- **Source of truth:** [src/jarvis/capabilities/skills/_registry.py](../../src/jarvis/capabilities/skills/_registry.py)
