...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/synthesizer.py`
- **Purpose:** Synthétiseur de skills — génère et améliore des skills depuis des tâches accomplies.
- **Key symbols:** Classes: `_BlockDumper`, `SkillSynthesizer`; Functions: `_str_representer`
...
- **Source of truth:** [src/jarvis/capabilities/skills/synthesizer.py](../../src/jarvis/capabilities/skills/synthesizer.py)
