...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/_abi_compat.py`
- **Purpose:** Alias de namespace `skills` → `jarvis.capabilities.skills` — CDC §B.2bis.
...
- **Source of truth:** [src/jarvis/capabilities/skills/_abi_compat.py](../../src/jarvis/capabilities/skills/_abi_compat.py)
