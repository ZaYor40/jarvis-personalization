...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/executor.py`
- **Purpose:** Exécuteur de presets Jarvis — gère l'exécution step par step.
- **Key symbols:** Classes: `PresetExecutor`
...
- **Source of truth:** [src/jarvis/capabilities/skills/executor.py](../../src/jarvis/capabilities/skills/executor.py)
