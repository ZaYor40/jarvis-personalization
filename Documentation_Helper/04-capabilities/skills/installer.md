...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/installer.py`
- **Purpose:** Installation/désinstallation des skills depuis jarvis-skills.
- **Key symbols:** Classes: `SkillInstaller`
...
- **Source of truth:** [src/jarvis/capabilities/skills/installer.py](../../src/jarvis/capabilities/skills/installer.py)
