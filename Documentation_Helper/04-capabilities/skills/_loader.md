...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/_loader.py`
- **Purpose:** Module `capabilities/skills/_loader.py`.
- **Key symbols:** Functions: `_parse_skill_md`, `_check_requirements`, `load_skills`
...
- **Source of truth:** [src/jarvis/capabilities/skills/_loader.py](../../src/jarvis/capabilities/skills/_loader.py)
