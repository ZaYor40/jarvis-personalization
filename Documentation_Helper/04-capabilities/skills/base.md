...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/base.py`
- **Purpose:** Classe de base pour tous les skills Jarvis.
- **Key symbols:** Classes: `SkillBase`, `PresetStep`, `PresetSkill`
...
- **Source of truth:** [src/jarvis/capabilities/skills/base.py](../../src/jarvis/capabilities/skills/base.py)
