...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/__init__.py`
- **Purpose:** jarvis.capabilities.skills — gestion des skills installés.
...
- **Source of truth:** [src/jarvis/capabilities/skills/__init__.py](../../src/jarvis/capabilities/skills/__init__.py)
