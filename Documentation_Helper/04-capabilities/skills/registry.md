...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/registry.py`
- **Purpose:** Gestionnaire des skills installés localement.
- **Key symbols:** Classes: `SkillRegistry`
...
- **Source of truth:** [src/jarvis/capabilities/skills/registry.py](../../src/jarvis/capabilities/skills/registry.py)
