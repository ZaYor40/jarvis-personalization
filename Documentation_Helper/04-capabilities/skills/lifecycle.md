...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/skills/lifecycle.py`
- **Purpose:** Cycle de vie d'une skill (CDC §7.2) — persisté SQLite dans jarvis_memory.db.
- **Key symbols:** Classes: `SkillLifecycle`
...
- **Source of truth:** [src/jarvis/capabilities/skills/lifecycle.py](../../src/jarvis/capabilities/skills/lifecycle.py)
