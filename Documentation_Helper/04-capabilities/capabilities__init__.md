...
- **Layer:** L1
- **Path:** `src/jarvis/capabilities/__init__.py`
- **Purpose:** L1 — Capabilities : outils et skills exposés à l'engine.
...
- **Source of truth:** [src/jarvis/capabilities/__init__.py](../../src/jarvis/capabilities/__init__.py)
