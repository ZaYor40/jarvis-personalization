...
- **Layer:** L3
- **Path:** `src/jarvis/setup_app.py`
- **Purpose:** Module `setup_app.py`.
- **Key symbols:** Functions: `_open_browser`, `main`
...
- **Source of truth:** [src/jarvis/setup_app.py](../../src/jarvis/setup_app.py)
