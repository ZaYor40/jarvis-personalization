...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/__init__.py`
- **Purpose:** L3 — Interfaces : points d'entrée externes (API HTTP, channels, voice, UI).
...
- **Source of truth:** [src/jarvis/interfaces/__init__.py](../../src/jarvis/interfaces/__init__.py)
