...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/whatsapp.py`
- **Purpose:** Stub WhatsApp pour Jarvis — à implémenter via Twilio ou WhatsApp Business API.
- **Key symbols:** Classes: `WhatsAppChannel`
...
- **Source of truth:** [src/jarvis/interfaces/channels/whatsapp.py](../../src/jarvis/interfaces/channels/whatsapp.py)
