...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/voice/__init__.py`
- **Purpose:** Process voix LiveKit — second composition root (CDC §C.1.8).
...
- **Source of truth:** [src/jarvis/interfaces/voice/__init__.py](../../src/jarvis/interfaces/voice/__init__.py)
