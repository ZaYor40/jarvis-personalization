...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/gateway.py`
- **Purpose:** Gateway de messagerie unifié Jarvis.
- **Key symbols:** Classes: `MessagingGateway`
...
- **Source of truth:** [src/jarvis/interfaces/channels/gateway.py](../../src/jarvis/interfaces/channels/gateway.py)
