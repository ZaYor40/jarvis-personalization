...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/base.py`
- **Purpose:** Abstractions de base pour les canaux de messagerie Jarvis.
- **Key symbols:** Classes: `Platform`, `IncomingMessage`, `MessageTarget`, `ChannelAdapter`
...
- **Source of truth:** [src/jarvis/interfaces/channels/base.py](../../src/jarvis/interfaces/channels/base.py)
