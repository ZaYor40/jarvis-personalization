...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/bluetooth/__init__.py`
- **Purpose:** Service Bluetooth — parsers macOS / Windows.
...
- **Source of truth:** [src/jarvis/hardware/bluetooth/__init__.py](../../src/jarvis/hardware/bluetooth/__init__.py)
