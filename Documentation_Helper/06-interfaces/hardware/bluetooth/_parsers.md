...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/bluetooth/_parsers.py`
- **Purpose:** Parsers Bluetooth — sortie texte des outils système → list[dict] UI-shaped.
- **Key symbols:** Functions: `parse_bt_macos`, `parse_bt_windows`
...
- **Source of truth:** [src/jarvis/hardware/bluetooth/_parsers.py](../../src/jarvis/hardware/bluetooth/_parsers.py)
