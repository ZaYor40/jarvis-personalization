...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/macropad_2k/models.py`
- **Purpose:** Module `hardware/macropad_2k/models.py`.
- **Key symbols:** Classes: `KeyChord`, `DeviceSettings`, `KeysOptions`, `HardwareSettings`, `LightingSettings`, `KeypadKeys`, `KeypadProfile`, `ProfileSlot`; Functions: `default_profile`, `default_bundle`, `get_active_profile`
...
- **Source of truth:** [src/jarvis/hardware/macropad_2k/models.py](../../src/jarvis/hardware/macropad_2k/models.py)
