...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/macropad_2k/__init__.py`
- **Purpose:** Module `hardware/macropad_2k/__init__.py`.
...
- **Source of truth:** [src/jarvis/hardware/macropad_2k/__init__.py](../../src/jarvis/hardware/macropad_2k/__init__.py)
