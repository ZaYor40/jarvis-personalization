...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/macropad_2k/launcher.py`
- **Purpose:** Module `hardware/macropad_2k/launcher.py`.
- **Key symbols:** Functions: `is_windows`, `list_installed_apps`, `_stable_alias_seed`, `_alias_from_seed`, `_launcher_cmd_body`, `_ensure_user_path_contains`, `create_app_launcher`, `open_device_manager`
...
- **Source of truth:** [src/jarvis/hardware/macropad_2k/launcher.py](../../src/jarvis/hardware/macropad_2k/launcher.py)
