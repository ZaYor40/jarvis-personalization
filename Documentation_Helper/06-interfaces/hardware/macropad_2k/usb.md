...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/macropad_2k/usb.py`
- **Purpose:** Module `hardware/macropad_2k/usb.py`.
- **Key symbols:** Functions: `keypad_hid_present`, `ch55x_bootloader_present`, `usb_status`
...
- **Source of truth:** [src/jarvis/hardware/macropad_2k/usb.py](../../src/jarvis/hardware/macropad_2k/usb.py)
