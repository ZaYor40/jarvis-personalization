...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/macropad_2k/profile_store.py`
- **Purpose:** Module `hardware/macropad_2k/profile_store.py`.
- **Key symbols:** Functions: `_new_slot_id`, `merge_profile`, `migrate_to_bundle`, `load_bundle`, `save_bundle`, `persist_bundle`, `load_default_workspace`, `save_default_workspace`
...
- **Source of truth:** [src/jarvis/hardware/macropad_2k/profile_store.py](../../src/jarvis/hardware/macropad_2k/profile_store.py)
