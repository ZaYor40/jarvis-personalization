...
- **Layer:** L1
- **Path:** `src/jarvis/hardware/__init__.py`
- **Purpose:** Module `hardware/__init__.py`.
...
- **Source of truth:** [src/jarvis/hardware/__init__.py](../../src/jarvis/hardware/__init__.py)
