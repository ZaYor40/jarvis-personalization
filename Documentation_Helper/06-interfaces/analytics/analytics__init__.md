...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/__init__.py`
- **Purpose:** Module `analytics/__init__.py`.
...
- **Source of truth:** [src/jarvis/analytics/__init__.py](../../src/jarvis/analytics/__init__.py)
