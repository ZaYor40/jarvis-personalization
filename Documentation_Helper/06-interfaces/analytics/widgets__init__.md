...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/__init__.py`
- **Purpose:** Module `analytics/widgets/__init__.py`.
...
- **Source of truth:** [src/jarvis/analytics/widgets/__init__.py](../../src/jarvis/analytics/widgets/__init__.py)
