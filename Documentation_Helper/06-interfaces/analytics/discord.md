...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/discord.py`
- **Purpose:** Widget Discord — membres et activité du serveur Le Labo.
- **Key symbols:** Classes: `DiscordWidget`
...
- **Source of truth:** [src/jarvis/analytics/widgets/discord.py](../../src/jarvis/analytics/widgets/discord.py)
