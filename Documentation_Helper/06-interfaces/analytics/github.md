...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/github.py`
- **Purpose:** Widget GitHub — stars, forks, commits récents.
- **Key symbols:** Classes: `GitHubWidget`
...
- **Source of truth:** [src/jarvis/analytics/widgets/github.py](../../src/jarvis/analytics/widgets/github.py)
