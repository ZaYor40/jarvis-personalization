...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/registry.py`
- **Purpose:** Gestionnaire des widgets analytics activés.
- **Key symbols:** Classes: `AnalyticsRegistry`
...
- **Source of truth:** [src/jarvis/analytics/registry.py](../../src/jarvis/analytics/registry.py)
