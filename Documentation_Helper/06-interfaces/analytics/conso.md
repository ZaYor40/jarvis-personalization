...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/conso.py`
- **Purpose:** Widget Consommation & Coûts — depuis memory_data/conso/.
- **Key symbols:** Classes: `ConsoWidget`
...
- **Source of truth:** [src/jarvis/analytics/widgets/conso.py](../../src/jarvis/analytics/widgets/conso.py)
