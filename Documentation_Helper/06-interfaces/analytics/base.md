...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/base.py`
- **Purpose:** Classe de base pour tous les widgets analytics Jarvis.
- **Key symbols:** Classes: `WidgetConfig`, `WidgetData`, `WidgetBase`
...
- **Source of truth:** [src/jarvis/analytics/widgets/base.py](../../src/jarvis/analytics/widgets/base.py)
