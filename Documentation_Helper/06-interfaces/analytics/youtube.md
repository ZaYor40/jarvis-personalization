...
- **Layer:** L1
- **Path:** `src/jarvis/analytics/widgets/youtube.py`
- **Purpose:** Widget YouTube Analytics — nécessite YOUTUBE_API_KEY.
- **Key symbols:** Classes: `YouTubeWidget`
...
- **Source of truth:** [src/jarvis/analytics/widgets/youtube.py](../../src/jarvis/analytics/widgets/youtube.py)
