...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/setup.py`
- **Purpose:** Wiring des canaux messaging au boot du process API.
...
- **Source of truth:** [src/jarvis/interfaces/channels/setup.py](../../src/jarvis/interfaces/channels/setup.py)
