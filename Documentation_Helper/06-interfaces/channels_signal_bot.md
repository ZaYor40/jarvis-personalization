...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/signal_bot.py`
- **Purpose:** Stub Signal pour Jarvis — à implémenter via signal-cli ou AsamiSignal.
- **Key symbols:** Classes: `SignalChannel`
...
- **Source of truth:** [src/jarvis/interfaces/channels/signal_bot.py](../../src/jarvis/interfaces/channels/signal_bot.py)
