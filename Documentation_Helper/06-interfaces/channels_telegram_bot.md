...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/telegram_bot.py`
- **Purpose:** Canal Telegram pour Jarvis.
- **Key symbols:** Classes: `_TelegramNetworkFilter`, `TelegramChannel`; Functions: `get_telegram_channel`
...
- **Source of truth:** [src/jarvis/interfaces/channels/telegram_bot.py](../../src/jarvis/interfaces/channels/telegram_bot.py)
