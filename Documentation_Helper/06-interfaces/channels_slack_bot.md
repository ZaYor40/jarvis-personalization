...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/slack_bot.py`
- **Purpose:** Stub Slack pour Jarvis — à implémenter via Slack Bolt SDK.
- **Key symbols:** Classes: `SlackChannel`
...
- **Source of truth:** [src/jarvis/interfaces/channels/slack_bot.py](../../src/jarvis/interfaces/channels/slack_bot.py)
