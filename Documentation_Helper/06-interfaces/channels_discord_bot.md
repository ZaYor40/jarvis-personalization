...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/discord_bot.py`
- **Purpose:** Canal Discord pour Jarvis.
- **Key symbols:** Classes: `DiscordChannel`
...
- **Source of truth:** [src/jarvis/interfaces/channels/discord_bot.py](../../src/jarvis/interfaces/channels/discord_bot.py)
