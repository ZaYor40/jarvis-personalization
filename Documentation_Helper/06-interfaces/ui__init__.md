...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/ui/__init__.py`
- **Purpose:** Module `interfaces/ui/__init__.py`.
...
- **Source of truth:** [src/jarvis/interfaces/ui/__init__.py](../../src/jarvis/interfaces/ui/__init__.py)
