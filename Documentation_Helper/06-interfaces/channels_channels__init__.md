...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/channels/__init__.py`
- **Purpose:** Module `interfaces/channels/__init__.py`.
...
- **Source of truth:** [src/jarvis/interfaces/channels/__init__.py](../../src/jarvis/interfaces/channels/__init__.py)
