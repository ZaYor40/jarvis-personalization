...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/vision.py`
- **Purpose:** Module `interfaces/api/vision.py`.
- **Key symbols:** Classes: `ObjectDetectedPayload`, `FaceRecognitionPayload`; Functions: `_get_or_init_frame_recognizer`
...
- **Source of truth:** [src/jarvis/interfaces/api/vision.py](../../src/jarvis/interfaces/api/vision.py)
