...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/connectors.py`
- **Purpose:** État de santé des connecteurs OAuth/API (M5 intégration UI).
- **Key symbols:** Functions: `_safe_load_json`, `_google_health`, `_spotify_health`, `_deezer_health`, `_env_present`
...
- **Source of truth:** [src/jarvis/interfaces/api/connectors.py](../../src/jarvis/interfaces/api/connectors.py)
