...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/devices.py`
- **Purpose:** Devices + Connectors API — Phase E §E.1.3.
...
- **Source of truth:** [src/jarvis/interfaces/api/config/devices.py](../../src/jarvis/interfaces/api/config/devices.py)
