...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/llm.py`
- **Purpose:** LLM status + Ollama API — Phase E §E.1.3.
- **Key symbols:** Classes: `OllamaPullBody`
...
- **Source of truth:** [src/jarvis/interfaces/api/config/llm.py](../../src/jarvis/interfaces/api/config/llm.py)
