...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/__init__.py`
- **Purpose:** Config API — agrégat des 4 sous-modules (Phase E §E.1.3).
...
- **Source of truth:** [src/jarvis/interfaces/api/config/__init__.py](../../src/jarvis/interfaces/api/config/__init__.py)
