...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/settings.py`
- **Purpose:** Settings API + hot-swap LLM provider — Phase E §E.1.3.
- **Key symbols:** Classes: `SettingUpdateBody`, `TestKeyBody`
...
- **Source of truth:** [src/jarvis/interfaces/api/config/settings.py](../../src/jarvis/interfaces/api/config/settings.py)
