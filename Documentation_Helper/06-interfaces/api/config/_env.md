...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/_env.py`
- **Purpose:** Helpers `.env` partagés par les sous-modules config (Phase E §E.1.3).
- **Key symbols:** Functions: `_mask`, `_read_env`, `_write_env`, `write_env_batch`
...
- **Source of truth:** [src/jarvis/interfaces/api/config/_env.py](../../src/jarvis/interfaces/api/config/_env.py)
