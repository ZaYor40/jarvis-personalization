...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/config/permissions.py`
- **Purpose:** Permissions runtime + Approvals API — Phase E §E.1.3.
- **Key symbols:** Classes: `PermissionPatch`, `ApprovalCategoryUpdate`, `ApprovalResolveBody`
...
- **Source of truth:** [src/jarvis/interfaces/api/config/permissions.py](../../src/jarvis/interfaces/api/config/permissions.py)
