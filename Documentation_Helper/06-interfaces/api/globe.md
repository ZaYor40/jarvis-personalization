...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/globe.py`
- **Purpose:** Globe data API — flights (OpenSky), weather (Open-Meteo), config.
- **Key symbols:** Functions: `_region`
...
- **Source of truth:** [src/jarvis/interfaces/api/globe.py](../../src/jarvis/interfaces/api/globe.py)
