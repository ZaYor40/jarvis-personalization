...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/analytics.py`
- **Purpose:** Analytics — stats Jarvis locales + YouTube Data API v3 + routes API.
...
- **Source of truth:** [src/jarvis/interfaces/api/analytics.py](../../src/jarvis/interfaces/api/analytics.py)
