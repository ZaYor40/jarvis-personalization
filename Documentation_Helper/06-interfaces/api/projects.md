...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/projects.py`
- **Purpose:** API REST pour les projets agent worker.
- **Key symbols:** Classes: `ApprovalBody`, `ResetStepsBody`; Functions: `_orch`
...
- **Source of truth:** [src/jarvis/interfaces/api/projects.py](../../src/jarvis/interfaces/api/projects.py)
