...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/memory.py`
- **Purpose:** Module `interfaces/api/memory.py`.
- **Key symbols:** Classes: `_ContentBody`, `_CorrectionBody`; Functions: `_mem_dir`
...
- **Source of truth:** [src/jarvis/interfaces/api/memory.py](../../src/jarvis/interfaces/api/memory.py)
