...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/routines.py`
- **Purpose:** Endpoints read-only pour le journal des routines planifiées (RoutineStore).
- **Key symbols:** Functions: `_get_store`
...
- **Source of truth:** [src/jarvis/interfaces/api/routines.py](../../src/jarvis/interfaces/api/routines.py)
