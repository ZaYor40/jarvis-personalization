...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/deezer.py`
- **Purpose:** Module `interfaces/api/deezer.py`.
- **Key symbols:** Functions: `_token_path`, `_load_token`, `_save_token`, `_get_access_token`
...
- **Source of truth:** [src/jarvis/interfaces/api/deezer.py](../../src/jarvis/interfaces/api/deezer.py)
