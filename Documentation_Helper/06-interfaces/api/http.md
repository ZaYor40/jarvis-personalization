...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/http.py`
- **Purpose:** Module `interfaces/api/http.py`.
...
- **Source of truth:** [src/jarvis/interfaces/api/http.py](../../src/jarvis/interfaces/api/http.py)
