...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/budget.py`
- **Purpose:** Endpoints read-only pour le suivi de budget / coûts (BudgetGuard).
...
- **Source of truth:** [src/jarvis/interfaces/api/budget.py](../../src/jarvis/interfaces/api/budget.py)
