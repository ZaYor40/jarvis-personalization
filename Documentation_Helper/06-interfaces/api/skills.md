...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/skills.py`
- **Purpose:** Module `interfaces/api/skills.py`.
- **Key symbols:** Functions: `_lab`, `_lifecycle`, `_record_to_dict`
...
- **Source of truth:** [src/jarvis/interfaces/api/skills.py](../../src/jarvis/interfaces/api/skills.py)
