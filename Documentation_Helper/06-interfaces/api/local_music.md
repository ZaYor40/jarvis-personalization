...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/local_music.py`
- **Purpose:** Module `interfaces/api/local_music.py`.
- **Key symbols:** Functions: `_backend`, `_macos_state_from_output`, `_sniff_mime`, `_resolve_art`, `_state_from_mpris`, `_list_players`, `_pick_player`, `_mpris_state_blocking`, `_mpris_control_blocking`
...
- **Source of truth:** [src/jarvis/interfaces/api/local_music.py](../../src/jarvis/interfaces/api/local_music.py)
