...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/spotify.py`
- **Purpose:** Module `interfaces/api/spotify.py`.
...
- **Source of truth:** [src/jarvis/interfaces/api/spotify.py](../../src/jarvis/interfaces/api/spotify.py)
