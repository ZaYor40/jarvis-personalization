...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/music.py`
- **Purpose:** Module `interfaces/api/music.py`.
...
- **Source of truth:** [src/jarvis/interfaces/api/music.py](../../src/jarvis/interfaces/api/music.py)
