...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/chat.py`
- **Purpose:** Module `interfaces/api/chat.py`.
- **Key symbols:** Classes: `ToolExecuteRequest`, `VoiceGenerateRequest`
...
- **Source of truth:** [src/jarvis/interfaces/api/chat.py](../../src/jarvis/interfaces/api/chat.py)
