...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/macropad_2k.py`
- **Purpose:** Module `interfaces/api/macropad_2k.py`.
- **Key symbols:** Classes: `WorkspaceBody`, `ProfileBundleBody`, `CompileBody`, `UploadBody`, `LauncherBody`; Functions: `_resolve_workspace`
...
- **Source of truth:** [src/jarvis/interfaces/api/macropad_2k.py](../../src/jarvis/interfaces/api/macropad_2k.py)
