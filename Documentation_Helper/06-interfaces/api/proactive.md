...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/proactive.py`
- **Purpose:** Module `interfaces/api/proactive.py`.
- **Key symbols:** Classes: `RectifyBody`, `ConfirmBody`
...
- **Source of truth:** [src/jarvis/interfaces/api/proactive.py](../../src/jarvis/interfaces/api/proactive.py)
