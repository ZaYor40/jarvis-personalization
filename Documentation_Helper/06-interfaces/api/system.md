...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/system.py`
- **Purpose:** Module `interfaces/api/system.py`.
- **Key symbols:** Functions: `_mem_dir`
...
- **Source of truth:** [src/jarvis/interfaces/api/system.py](../../src/jarvis/interfaces/api/system.py)
