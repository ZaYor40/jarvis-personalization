...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/ui.py`
- **Purpose:** Module `interfaces/api/ui.py`.
- **Key symbols:** Classes: `HealthResponse`; Functions: `inject_client_config`, `_ui_html_response`, `_versioned_html`
...
- **Source of truth:** [src/jarvis/interfaces/api/ui.py](../../src/jarvis/interfaces/api/ui.py)
