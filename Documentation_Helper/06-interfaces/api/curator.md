...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/curator.py`
- **Purpose:** Endpoints Curator + Command Center (CDC §10).
- **Key symbols:** Functions: `_curator`, `_command_center`
...
- **Source of truth:** [src/jarvis/interfaces/api/curator.py](../../src/jarvis/interfaces/api/curator.py)
