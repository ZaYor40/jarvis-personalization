...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/admin.py`
- **Purpose:** Module `interfaces/api/admin.py`.
- **Key symbols:** Classes: `ContentBody`, `SessionMeta`, `SessionMessage`, `TopicMeta`, `MemoryOverview`; Functions: `_memory_dir`
...
- **Source of truth:** [src/jarvis/interfaces/api/admin.py](../../src/jarvis/interfaces/api/admin.py)
