...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/__init__.py`
- **Purpose:** Module `interfaces/api/__init__.py`.
...
- **Source of truth:** [src/jarvis/interfaces/api/__init__.py](../../src/jarvis/interfaces/api/__init__.py)
