...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/briefing.py`
- **Purpose:** briefing.py — Preset de briefing post-wakeup : ouverture Safari + récap data.
- **Key symbols:** Classes: `OpenUrlBody`; Functions: `_briefing_enabled`, `_youtube_line`
...
- **Source of truth:** [src/jarvis/interfaces/api/briefing.py](../../src/jarvis/interfaces/api/briefing.py)
