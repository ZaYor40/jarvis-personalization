...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/sessions.py`
- **Purpose:** Module `interfaces/api/sessions.py`.
- **Key symbols:** Classes: `_TitleBody`; Functions: `_mem_dir`, `_session_titles_path`, `_load_titles`, `_save_titles`
...
- **Source of truth:** [src/jarvis/interfaces/api/sessions.py](../../src/jarvis/interfaces/api/sessions.py)
