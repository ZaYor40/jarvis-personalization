...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/widgets.py`
- **Purpose:** Module `interfaces/api/widgets.py`.
- **Key symbols:** Classes: `Task`, `TasksResponse`, `TaskCreate`, `TaskPatch`, `CalEvent`, `EventsResponse`; Functions: `_notion_headers`, `_load_calendar_creds`
...
- **Source of truth:** [src/jarvis/interfaces/api/widgets.py](../../src/jarvis/interfaces/api/widgets.py)
