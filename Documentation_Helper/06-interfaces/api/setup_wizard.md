...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/setup_wizard.py`
- **Purpose:** Module `interfaces/api/setup_wizard.py`.
- **Key symbols:** Classes: `SetupCompletePayload`; Functions: `_find_available_port`
...
- **Source of truth:** [src/jarvis/interfaces/api/setup_wizard.py](../../src/jarvis/interfaces/api/setup_wizard.py)
