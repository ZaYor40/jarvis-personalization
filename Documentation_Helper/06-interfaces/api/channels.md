...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/channels.py`
- **Purpose:** Router FastAPI pour les webhooks entrants des canaux de messagerie.
...
- **Source of truth:** [src/jarvis/interfaces/api/channels.py](../../src/jarvis/interfaces/api/channels.py)
