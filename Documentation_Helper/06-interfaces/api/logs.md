...
- **Layer:** L3
- **Path:** `src/jarvis/interfaces/api/logs.py`
- **Purpose:** Module `interfaces/api/logs.py`.
- **Key symbols:** Functions: `_log_sink`
...
- **Source of truth:** [src/jarvis/interfaces/api/logs.py](../../src/jarvis/interfaces/api/logs.py)
