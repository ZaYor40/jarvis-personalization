...
- **Layer:** L1
- **Path:** `src/jarvis/providers/vision/object_detector.py`
- **Purpose:** Détection d'objets en temps réel avec YOLOv8n.
- **Key symbols:** Classes: `DetectedObject`, `DetectionResult`, `ObjectDetector`
...
- **Source of truth:** [src/jarvis/providers/vision/object_detector.py](../../src/jarvis/providers/vision/object_detector.py)
