...
- **Layer:** L1
- **Path:** `src/jarvis/providers/vision/objects_queue.py`
- **Purpose:** Queue pub/sub pour les détections d'objets YOLO → WebSocket browser.
- **Key symbols:** Classes: `VisionObjectsQueue`; Functions: `get_vision_objects_queue`
...
- **Source of truth:** [src/jarvis/providers/vision/objects_queue.py](../../src/jarvis/providers/vision/objects_queue.py)
