...
- **Layer:** L1
- **Path:** `src/jarvis/providers/vision/__init__.py`
- **Purpose:** Module `providers/vision/__init__.py`.
...
- **Source of truth:** [src/jarvis/providers/vision/__init__.py](../../src/jarvis/providers/vision/__init__.py)
