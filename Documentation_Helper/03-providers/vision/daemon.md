...
- **Layer:** L1
- **Path:** `src/jarvis/providers/vision/daemon.py`
- **Purpose:** Daemon vision — détection d'objets YOLOv8n en background.
- **Key symbols:** Functions: `get_face_recognizer`
...
- **Source of truth:** [src/jarvis/providers/vision/daemon.py](../../src/jarvis/providers/vision/daemon.py)
