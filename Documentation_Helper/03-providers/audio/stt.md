...
- **Layer:** L1
- **Path:** `src/jarvis/providers/audio/stt.py`
- **Purpose:** Module `providers/audio/stt.py`.
- **Key symbols:** Functions: `_load_model`, `_run_transcribe`
...
- **Source of truth:** [src/jarvis/providers/audio/stt.py](../../src/jarvis/providers/audio/stt.py)
