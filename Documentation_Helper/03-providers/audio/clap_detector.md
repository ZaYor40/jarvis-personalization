...
- **Layer:** L1
- **Path:** `src/jarvis/providers/audio/clap_detector.py`
- **Purpose:** Détection de double clap via le micro.
- **Key symbols:** Classes: `ClapDetector`
...
- **Source of truth:** [src/jarvis/providers/audio/clap_detector.py](../../src/jarvis/providers/audio/clap_detector.py)
