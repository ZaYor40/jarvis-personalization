...
- **Layer:** L1
- **Path:** `src/jarvis/providers/audio/tts.py`
- **Purpose:** Module `providers/audio/tts.py`.
- **Key symbols:** Classes: `TTSEngine`; Functions: `_extract_gemini_pcm`, `_pcm_to_wav`
...
- **Source of truth:** [src/jarvis/providers/audio/tts.py](../../src/jarvis/providers/audio/tts.py)
