...
- **Layer:** L1
- **Path:** `src/jarvis/providers/audio/__init__.py`
- **Purpose:** Module `providers/audio/__init__.py`.
...
- **Source of truth:** [src/jarvis/providers/audio/__init__.py](../../src/jarvis/providers/audio/__init__.py)
