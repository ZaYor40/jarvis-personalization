...
- **Layer:** L1
- **Path:** `src/jarvis/providers/llm/local.py`
- **Purpose:** Module `providers/llm/local.py`.
- **Key symbols:** Classes: `OllamaProvider`; Functions: `_strip_think`, `_claude_tools_to_ollama`
...
- **Source of truth:** [src/jarvis/providers/llm/local.py](../../src/jarvis/providers/llm/local.py)
