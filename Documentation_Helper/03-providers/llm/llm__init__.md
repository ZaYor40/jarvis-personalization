...
- **Layer:** L1
- **Path:** `src/jarvis/providers/llm/__init__.py`
- **Purpose:** Module `providers/llm/__init__.py`.
...
- **Source of truth:** [src/jarvis/providers/llm/__init__.py](../../src/jarvis/providers/llm/__init__.py)
