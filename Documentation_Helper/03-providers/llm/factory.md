...
- **Layer:** L1
- **Path:** `src/jarvis/providers/llm/factory.py`
- **Purpose:** Module `providers/llm/factory.py`.
- **Key symbols:** Functions: `get_llm_provider`, `create_background_llm`, `create_voice_llm`
...
- **Source of truth:** [src/jarvis/providers/llm/factory.py](../../src/jarvis/providers/llm/factory.py)
