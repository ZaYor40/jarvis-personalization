...
- **Layer:** L1
- **Path:** `src/jarvis/providers/llm/base.py`
- **Purpose:** Module `providers/llm/base.py`.
- **Key symbols:** Classes: `LLMProvider`
...
- **Source of truth:** [src/jarvis/providers/llm/base.py](../../src/jarvis/providers/llm/base.py)
