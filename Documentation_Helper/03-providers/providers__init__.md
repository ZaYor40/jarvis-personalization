...
- **Layer:** L1
- **Path:** `src/jarvis/providers/__init__.py`
- **Purpose:** L1 — Providers : implémentations concrètes des contrats kernel.
...
- **Source of truth:** [src/jarvis/providers/__init__.py](../../src/jarvis/providers/__init__.py)
