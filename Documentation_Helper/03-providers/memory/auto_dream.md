...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/auto_dream.py`
- **Purpose:** Module `providers/memory/auto_dream.py`.
- **Key symbols:** Classes: `AutoDream`; Functions: `_default_prefs`, `_micro_system`, `_deep_system`
...
- **Source of truth:** [src/jarvis/providers/memory/auto_dream.py](../../src/jarvis/providers/memory/auto_dream.py)
