...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/visual_memory.py`
- **Purpose:** Mémoire visuelle — stocke les souvenirs visuels de Jarvis.
- **Key symbols:** Functions: `_extract_tags`, `_ensure_file`
...
- **Source of truth:** [src/jarvis/providers/memory/visual_memory.py](../../src/jarvis/providers/memory/visual_memory.py)
