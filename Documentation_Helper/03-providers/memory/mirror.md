...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/mirror.py`
- **Purpose:** Miroir Markdown UNIDIRECTIONNEL — SQLite → MD lecture seule (CDC §6.7).
- **Key symbols:** Classes: `MirrorReport`, `MemoryMirror`; Functions: `_file_to_title`, `_render`
...
- **Source of truth:** [src/jarvis/providers/memory/mirror.py](../../src/jarvis/providers/memory/mirror.py)
