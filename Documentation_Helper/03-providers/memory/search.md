...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/search.py`
- **Purpose:** Module `providers/memory/search.py`.
- **Key symbols:** Classes: `VectorIndex`, `FTSIndex`; Functions: `_chunk_text`
...
- **Source of truth:** [src/jarvis/providers/memory/search.py](../../src/jarvis/providers/memory/search.py)
