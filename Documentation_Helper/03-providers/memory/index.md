...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/index.py`
- **Purpose:** Module `providers/memory/index.py`.
- **Key symbols:** Classes: `MemoryIndex`
...
- **Source of truth:** [src/jarvis/providers/memory/index.py](../../src/jarvis/providers/memory/index.py)
