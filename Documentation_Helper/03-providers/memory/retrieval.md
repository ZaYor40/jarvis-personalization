...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/retrieval.py`
- **Purpose:** Retrieval : facts actifs + score importance × récence × pertinence × confidence (§6.9).
- **Key symbols:** Classes: `ScoredFact`, `MemoryRetrieval`; Functions: `_bm25_to_relevance`, `_recency_factor`
...
- **Source of truth:** [src/jarvis/providers/memory/retrieval.py](../../src/jarvis/providers/memory/retrieval.py)
