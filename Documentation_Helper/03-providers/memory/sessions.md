...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/sessions.py`
- **Purpose:** Module `providers/memory/sessions.py`.
- **Key symbols:** Classes: `SessionStore`
...
- **Source of truth:** [src/jarvis/providers/memory/sessions.py](../../src/jarvis/providers/memory/sessions.py)
