...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/consolidation.py`
- **Purpose:** Module `providers/memory/consolidation.py`.
- **Key symbols:** Classes: `ConsolidationAgent`, `CrossSessionRecall`
...
- **Source of truth:** [src/jarvis/providers/memory/consolidation.py](../../src/jarvis/providers/memory/consolidation.py)
