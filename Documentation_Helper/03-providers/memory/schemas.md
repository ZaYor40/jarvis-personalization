...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/schemas.py`
- **Purpose:** Ré-export de kernel.schemas (section Memory) — CDC §A.1.3.
...
- **Source of truth:** [src/jarvis/providers/memory/schemas.py](../../src/jarvis/providers/memory/schemas.py)
