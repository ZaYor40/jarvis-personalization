...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/user_model.py`
- **Purpose:** Modèle utilisateur dialectique inspiré de Honcho (Plastic Labs, MIT).
- **Key symbols:** Classes: `UserModel`
...
- **Source of truth:** [src/jarvis/providers/memory/user_model.py](../../src/jarvis/providers/memory/user_model.py)
