...
- **Layer:** L1
- **Path:** `src/jarvis/providers/memory/__init__.py`
- **Purpose:** Module `providers/memory/__init__.py`.
...
- **Source of truth:** [src/jarvis/providers/memory/__init__.py](../../src/jarvis/providers/memory/__init__.py)
