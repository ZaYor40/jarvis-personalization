...
- **Layer:** L1
- **Path:** `src/jarvis/providers/youtube.py`
- **Purpose:** youtube.py — Snapshot YouTube (Data API v3, clé seule) pour le briefing.
- **Key symbols:** Classes: `YouTubeSnapshot`
...
- **Source of truth:** [src/jarvis/providers/youtube.py](../../src/jarvis/providers/youtube.py)
